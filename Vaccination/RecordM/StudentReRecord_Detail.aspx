<%@ Page Language="C#" AutoEventWireup="true" CodeFile="StudentReRecord_Detail.aspx.cs" Inherits="Vaccination_RecordM_StudentReRecord_Detail"  MasterPageFile="~/MasterPage/Custom/DecoratedMasterPage.master" %>
...
<div class="listTb">
    ...
    <input  type="hidden" name="ss" ng-model="VM.Sary"/>
  </div>
  </form>
</section>
    <script>
