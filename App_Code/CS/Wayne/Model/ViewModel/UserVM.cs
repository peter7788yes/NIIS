...
public class UserVM
{
    ...
    public List<string> FileInfoIDsList
    {
        get
        {
            ...
            var list = new List<string>(FileInfoIDs.Split(new string[] { "," }, StringSplitOptions.RemoveEmptyEntries));

            return list.ConvertAll<string>((item) => QueryStringEncryptToolS.Encrypt(item));
        }
    }
}